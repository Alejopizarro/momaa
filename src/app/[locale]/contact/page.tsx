...
export default function ContactPage({
  ...
  return (
    <main className="bg-white min-h-screen pt-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 min-h-[600px]">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <a
                ...
                className="text-sm text-[#111111] hover:text-[#E8572A] transition-colors duration-200 flex items-center gap-3"
              >
                <span className="w-1.5 h-1.5 bg-[#E8572A] flex-shrink-0" />
                andres@momaa.es
              </a>
              <a
                href="mailto:andres@coamalaga.es"
                className="text-sm text-[#111111] hover:text-[#E8572A] transition-colors duration-200 flex items-center gap-3"
              >
