...
export function ContactSection() {
  ...
  return (
    <section
      id="contacto"
      className="py-8 max-w-7xl mx-auto px-6 md:py-16 lg:py-24"
    >
      <div className="bg-surface border-t-2 border-t-[#E8572A]  px-6 md:px-12 py-12">
            ...
            <div>
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-4">
                  ...
                  />
                  <div>
                    <p className="text-[10px] font-black uppercase tracking-widest text-black/25 mb-1">
                      Estudio
                    </p>
                    <p className="text-sm text-black/55 leading-relaxed whitespace-pre-line">
                      {t("address")}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-sm text-[#111111] hover:text-[#E8572A] transition-colors block"
                    >
                      {t("phone1")}
                    </a>
                    <a
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a
                      href={`mailto:${t("email")}`}
                      className="text-sm text-black/55 hover:text-[#E8572A] transition-colors"
                    >
                      {t("email")}
                    </a>
                  </div>
